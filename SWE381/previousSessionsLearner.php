    ...
    <section class="section-bg">
      ...
      <div class="sessions">
          ...
          while ($row = mysqli_fetch_assoc($result)) {
              ...
              $sql="SELECT * FROM  review_and_rating WHERE partner_id=$PartnerID AND learner_id=$learner_id";
              	$result2 = mysqli_query($conn, $sql);
                if (mysqli_num_rows($result2) == 0){

			  echo '<a class="btn" id="reviewButton" href="ReviewLearner.php?partner_id=' . $PartnerID . '&learner_id=' . $learner_id . '&session_id=' . $SessionID . '"><svg height="24" width="24" fill="#FFFFFF" viewBox="0 0 24 24" data-name="Layer 1" class="sparkle"><path d="M10,21.236,6.755,14.745,0.264,11.5,6.755,8.255,10,1.764l3.245,6.491L19.736,11.5l-6.491,3.245ZM18,21l1.5,3L21,21l3-1.5L21,18l-1.5-3L18,18l-3,1.5ZM19.333,4.667,20.5,7l1.167-2.333L24,3.5,21.667,2.333,20.5,0,19.333,2.333,17,3.5Z"></path></svg><span class="text">Rate!</span></a>';
                echo "</div>";
                
                }else {
                    			  echo '<a class="btn" id="reviewButton" href=""><svg height="24" width="24" fill="#FFFFFF" viewBox="0 0 24 24" data-name="Layer 1" class="sparkle"><path d="M10,21.236,6.755,14.745,0.264,11.5,6.755,8.255,10,1.764l3.245,6.491L19.736,11.5l-6.491,3.245ZM18,21l1.5,3L21,21l3-1.5L21,18l-1.5-3L18,18l-3,1.5ZM19.333,4.667,20.5,7l1.167-2.333L24,3.5,21.667,2.333,20.5,0,19.333,2.333,17,3.5Z"></path></svg><span class="text">Partner Rated!</span></a>';

                    echo '<p>You have rated this partner</p>';
                echo "</div>";
                }
          }
          }
